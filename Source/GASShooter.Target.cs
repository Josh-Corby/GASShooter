...
public class GASShooterTarget : TargetRules
{
	public GASShooterTarget(TargetInfo Target) : base(Target)
	{
        ...
        ApplySharedGASShooterTargetSettings(this);
	}

    private static bool bHasWarnedAboutShared = false;

    internal static void ApplySharedGASShooterTargetSettings(TargetRules Target)
    {
        ...
        if (Target.BuildEnvironment == TargetBuildEnvironment.Unique)
        {
            ...
            GASShooterTarget.ConfigureGameFeaturePlugins(Target);
        }
        else
        {
            // !!!!!!!!!!!! WARNING !!!!!!!!!!!!!
