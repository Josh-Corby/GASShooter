...
#include "GSInteractionOption.generated.h"
...
public:
	...
	TScriptInterface<IGSInteractableTargetInterface> InteractableTarget;
...
public:
	FORCEINLINE bool operator==(const FGSInteractionOption& Other) const
	{
