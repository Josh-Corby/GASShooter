...
UAsyncAction_ObserveTeam* UAsyncAction_ObserveTeam::InternalObserveTeamChanges(TScriptInterface<IGSTeamAgentInterface> TeamActor)
{
...
void UAsyncAction_ObserveTeam::SetReadyToDestroy()
{
    ...
    if (IGSTeamAgentInterface* TeamInterface = TeamInterfacePtr.Get())
    {
